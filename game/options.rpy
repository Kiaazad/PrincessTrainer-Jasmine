...
define config.name = _("Princess Trainer: Jasmine")
...
define build.name = "PrincessTrainerJasmine"
...
define config.save_directory = "PrincessTrainerJasmine-1551507216"
