...
label chitchat_4:
    ...
    abd "I guess you're right, Jafar. But wouldn't I age normally when inside of the lamp?"
...
label chitchat_7:
    ...
    abd "But what does that have to do with writhing books?"
    jaf "Patience my friend. I'm not finished yet."
    jaf "Where you born a fish vendor?"
    abd "No I learned it from my father."
...
label chitchat_8:
    ...
    abd "xxx looks like xxx 's filled with liquid."
    ...
    abd "But we breath out the same air we breath in, that can't have food in it."
...
label chitchat_9:
    ...
    abd "They're abusing people's beliefs. They'll go to hell."
...
label chitchat_10:
    ...
    abd "Huh..."
    jaf "What's the matter?"
    abd "It feels wierd hearing you talk about killing people."
    abd "I never seen you at any execution when you were the vizier."
    ...
    abd "I figured you're not the killing type. It's not hard to hire one of Asasiyyun to kill him."
