label ch0:
    ...
    abd "Phew..."
    abd "Not even a tumbleweed!"
    abd "I need to find another area to collect thorns."
    abd "There's nothing but sand left around here."
    show ev 01
    ...
    abd "Hmph, I wish these rumours were believable."
    menu:
        "rub the lamp!":
            hide abd
            ...
            abd "{size=30}Are you? {w=.5}a... {w=.5}a Genie?"
            ...
            abd "They blamed it on you returning to Agrabah. {w=.6}but..."
            ...
            abd "No fish to sell, {w=.4}no money to buy barrels, {w=.4}no money to buy fish food, {w=.4}no money to buy bread."
            show jaf thinking at right
            jaf "Well... That explains the missing belly."
            abd "And my fish pond dried up, Jafar. {w=.5}All of my fish died. {w=.8}I'm a thorn collector now."
            show jaf normal at right
            ...
            abd "Roughly a year."
            jaf "Is that so?"
            abd "Yes, {w=.8}My mother died few months ago, after I lost my business."
