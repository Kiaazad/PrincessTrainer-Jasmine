label ch0:
    ...
    me "An oil lamp?"
    me "Looks new."
    me "My lucky day! I can sell this and eat a full meal tonight."
    $ qlog.got(sell_lamp)
    show bg bg1
    show me confused at left
    with dissolve
    me "They say Aladdin found his Genie in one of these, and he wished for all the things he has now."
    me "I wish I could believe in those rumors."
    menu:
        "rub the lamp!":
            hide me
            ...
            jaf "Is it that obvious? {w=.5}let me..."label ch0:
    default skip_next = "skip_to_ch1"
    call desert_0
    show bg bg1
    show screen skips
    ...
    menu:
        ...
        "Don't be naive, {w=.5}let's go back to the city.":
            ...
            show me sad at left
            me "Well... {w=.6}I can't do that anymore."
            me "Aladdin destroyed my fish shack in one of his fights."
            me "They blamed it on you returning to Agrabah. {w=.6}but..."
            me "Every other day he would drag some problem into the bazaar and mess the place up."
            me "Breaking my fish barrels every single time. {w=.5}Those cost lots of money."
            ...
            me "And my fish pond dried up Jafar. {w=.5}All of my fish died. {w=.8}I'm a thorn collector now."
            show jaf normal at right
            jaf "Agrabah is an oasis my friend. {w=.5}A drop in the middle of scorching sand."
            show me normal at left
            jaf "I warned Sultan about wasting too much of drinkable water for fountains and his garden."
            jaf "He'd never listen."
            jaf "Or never cared."
            jaf "Either way he's to blame. {w=.4}That mother fucking old piece of shit."
            me "..."
            show jaf thinking at right
            jaf "Hey, {w=.4}hows your mother?"
            show me sad at left
            ...
            if not persistent.theme_change:
                ...
                me "Jafar?"
                show jaf normal at right
                jaf "Ah, {w=.5}sorry Abdul, {w=.5}got distracted. Anyways."
            else:
                me "She tried to help me by working..."
                jaf "Aha? {w=.8}tell me about it later."
                show me confused at left
            ...
            show jaf normal at right
            jaf "I'm a Genie and your rubbed me out {w=.4}...hehe..."
            jaf "Now you have three wishes I shall grant."
            me "Really?"
            ...
            jaf "Good, {w=.5}nobody does that. {w=.5}Anywhere you saw somebody talking to himself, {w=.5}it's totally fake."
            show me embarrassed at left
            jaf "As I was saying: {w=.5}You wish and I'll try to twist your words against you."
            show me alert at left
            me "Against me? {w=.5}But why?"
            show jaf thinking at right
            jaf "I spouse it's something about teaching you a lesson."
            ...
            if not persistent.theme_change:
                ...
                jaf "Yes"
            jaf "If you promise to help me get my revenge from those three idiots..."
            jaf "Whom trapped me in this thing."
            jaf "Let me decide what to wish for your first, {w=.5}and second wish..."
            ...
            menu:
                ...
                "Sure..!?":
                    ...
                    $ qlog.got(jafars_revenge)
                    $ qlog.cancel(sell_lamp)
                    jaf "Bring the faggot, {w=.5}We need any money we can get our hands on."
                    $ msg.msg("You got CamelThorns")
                    jump ch1
                "No! I want my wishes":
                    show me normal at left
                    ...
                    menu:
                        ...
                        "I want my wishes Jafar.":
                            jaf "So be it."
                            jump wishes
                        "Alright, alright, I yield, don's screwed me, whatever that means.":
                            jaf "Good let us haste! {w=.5}Time's a-wastin'."
                            $ qlog.got(jafars_revenge)
                            $ qlog.cancel(sell_lamp)
                            show me confused at left
                            me "What?"
                            jaf "Something I've heard, {w=.5}never mind."
                            jump ch1
        "Don't be naive, {w=.5}let's go back to the city.":
            jump endless_grind
