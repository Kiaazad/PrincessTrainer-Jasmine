label ch1:
    ...
    me "No, it's all of the garbage in the alleys."
    me "They say: You betrayed the Sultan. They say you returned and tried to kill him."
    me "But things where better when you where in charge."
    me "After you, nobody is doing their jobs."
    ...
    me "I was there when the Genie picked up tha palace and put in on the hill top."
    me "They said you commanded him."
    me "And I've heard few things from palace guards here and there."
    me "Usually everything happens inside the palace walls when nobody is around."
    me "I've heard stories."
    ...
    jaf "Let's go to your house, This way?"
    me "No."
    ...
    jaf "It's resident moved to a bigger place."
    jaf "Follow me."
    jump ch2