...
label ch4:
    ...
    me "I don't think any pleasure can top all the wealth in the world, jafar."
    jaf "It would, you just don't understand it yet. I'll have to write a book on that as well."
    jaf "Anyways, you need to make some money to buy clothing."
    me "Can't you give me some money or the clothing with magic?"
    jaf "Of course I can, I have the absolute power! The universe is mine to command."
    jaf "But that might count as your wish. I don't want risking something that valuable."
    me "Good point, I would never think that ahead. No wonder you became a Vizier."
