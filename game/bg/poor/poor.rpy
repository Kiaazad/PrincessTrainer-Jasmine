...
label widows_house:
    ...
    menu:
        ...
        "I have a few questions.":
            ...
            wid "Well you see, under Jafar, the people had to adhere to strict courtship laws."
            abd "And rightfully so. The penalty for breaking them is death."
            wid "Yes, and the most important law was that no matter what, a woman's guardian, usually her father, had the final say on when she could marry someone."
            abd "Yes, I know the rules. So are you saying that since Jafar, err... {size=18}died...{/size} that those laws aren't followed anymore?"
            wid "Well, no. Most people in Aggrabar still obey the law as tradition."
            wid "But when the man Jafar appointed to uphold those laws, doesn't obey them himself..."
            abd "Jafar's man?"
            abd "You mean, {size=36}Rasoul!{/size}"
            wid "Yes..."
            abd "I see..."
            ...
            abd "Hang on! So, you're saying that Rasoul wanted to marry your daughter?"
            wid "Yes."
            abd "And your husband was against the idea?!"
            wid "Well yes, of course he was. Rasoul's reputation for frequenting brothels is common knowledge throughout Agrabah."
            wid "Ever since Jafar died, this city's repugnant underbelly has started spilling into the streets."
            wid "And my husband spared no effort to protect our daughter from all of it, especialy Rasoul."
            ...
            abd "So now Rasoul has your daughter, and I'm assuming he's threatened you or her somehow, if you try to get her back?"
            "..."
            wid "He told me that if I ever want to see her again, I have to sexually relieve him or any of his friends he sends to my home."
            wid "Otherwise he'll sell her into slavery."
            abd "That's terrible..."
        ...
        "I can help you.":
            ...
            abd "I can help save your daughter, if you'll let me."
